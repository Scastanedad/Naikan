...
class Boss4(Enemigos):
    def __init__(self, x, y, in_pos):
        super().__init__(
            ...
            heigth=64,
            color=(200, 200, 100),
            sprite_path=resource_path("assets/sprites/bosses/boss_mundo4.png"),
        ...
        #Atributos relacionados al comportamiento especifico de este boss
        self.Fase = 1
    ...
    def update(self, dt, jugador):
        ...
        if self.cooldownSP >= self.intervaloSP:
            ...
            if random.randint(1, 2) == 1:
                eventos.append(EnemigoMelee(self.x, self.y, 3, [self.x, self.y]))
            else:
                eventos.append(EnemigoDistancia(self.x, self.y, 3, [self.x, self.y]))
        return eventos
